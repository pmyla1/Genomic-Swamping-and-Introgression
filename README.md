...
One of the major consequences of long-term hybridization between rare and common species is genomic swamping, which refers to the phenomenon of a reduction in genetic diversity of a rare species through recurrent hybridization with a more common species which breaks down reproductive barriers and drive the rare species to extinction as rare genotypes are replaced in the hybrids ([Ge et al., 2022](https://doi.org/10.1093/molbev/msac274)). 
