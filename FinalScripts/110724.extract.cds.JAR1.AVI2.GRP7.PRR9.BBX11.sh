...
#OUTPRR9=~/110724.GenesOfInterest/110724.g50798.PRR9.coords.fasta
OUTBBX11=~/110724.GenesOfInterest/110724.g50838.BBX11.coords.fasta
...
##use GATK FastaAlternateReferenceMaker to extract the CDS from the g50851.t1 gene encoding AVI2
 ...
 #  -V $VCF \
###########
##use GATK FastaAlternateReferenceMaker to extract the CDS from the g50878.t1 gene encoding GRP7
#gatk FastaAlternateReferenceMaker \
#	-R $REF \
#	-O $OUTGRP7 \
...
#	-V $VCF
###########
##use GATK FastaAlternateReferenceMaker to extract the CDS for the g50798.t1 gene
#gatk FastaAlternateReferenceMaker \
#   -R $REF \
#   -O $OUTPRR9 \
#   -L Cexcelsa_scaf_6:5961965-5962151 -L Cexcelsa_scaf_6:5962282-5962443 -L Cexcelsa_scaf_6:5962556-5962686 \
#   -L Cexcelsa_scaf_6:5962783-5963204 -L Cexcelsa_scaf_6:5963292-5963742 -L Cexcelsa_scaf_6:5963818-5963919 \
#   -V $VCF \
##########
##use GATK FastaAlternateReferenceMaker to extract the CDS from the g50838.t1 gene encoding BBX11	
gatk FastaAlternateReferenceMaker \
       -R $REF \
       -O $OUTBBX11 \
       -L Cexcelsa_scaf_6:6123212-6123676 -L Cexcelsa_scaf_6:6123775-6123927 -L Cexcelsa_scaf_6:6124001-6124336 \
       -V $VCF
###########
