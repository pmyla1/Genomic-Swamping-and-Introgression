...
OUTVCF=~/300524_HaplotypeCaller_output/090624_combined_genotyped/100624_filtered.best/110624_Ionops.allUKsamples.filtered.F4.vcf.gz
...
##copy the VCF
cp $OUTVCF ~/110624_Ionops.allUKsamples.filtered.F4.copy.vcf.gz
#unzip in preparation for LD pruning
gunzip ~/110624_Ionops.allUKsamples.filtered.F4.copy.vcf.gz
...
~/scripts/prune_ld -vcf ~/110624_Ionops.allUKsamples.filtered.F4.copy.vcf -mis 0.9 -maf 0.05 -r2 50 10 0.1 > ~/110624_LD.Pruned.Ionops.allUKsamples.vcf
##make a copy of the ld-pruned vcf
cp ~/110624_LD.Pruned.Ionops.allUKsamples.vcf ~/110624_LD.Pruned.Ionops.allUKsamples.copy.vcf
...
bgzip ~/110624_LD.Pruned.Ionops.allUKsamples.vcf
