...
gunzip ~/bcftools_gatk_output/110524_WG_allUKhex_allUKdips_someUKtets.vcf.gz
...
~/bcftools_gatk_output/prune_ld -vcf ~/bcftools_gatk_output/110524_WG_allUKhex_allUKdips_someUKtets.vcf -mis 0.9 -maf 0.05 -r2 100 50 0.1 > ~/bcftools_gatk_output/ld_pruned_110524_WG_allUKhex_allUKdips_someUKtets.vcf
...
bgzip ~/bcftools_gatk_output/ld_pruned_110524_WG_allUKhex_allUKdips_someUKtets.vcf

##bgzip the 110524_WG_allUKhex_allUKdips_someUKtets.vcf
bgzip ~/bcftools_gatk_output/110524_WG_allUKhex_allUKdips_someUKtets.vcf
