...
#####
##index the Chrom1_coords_1_1407794_F4_133.ann.vcf.gz file with gatk IndexFeatureFile
gatk IndexFeatureFile -I /gpfs01/home/pmyla1/bcftools_gatk_output/Chrom1_coords_1_1407794_F4_133.ann.vcf.gz

######
##use GATK SelectVariants to select all UK diploids, tetraploids, C. danica, and putative C. anglica
gatk SelectVariants -V /gpfs01/home/pmyla1/bcftools_gatk_output/Chrom1_coords_1_1407794_F4_133.ann.vcf.gz \
 ...
 -O /gpfs01/home/pmyla1/bcftools_gatk_output/Chrom1_coords_1_1407794_UK_dips_tets_danica_anglica.vcf.gz \
