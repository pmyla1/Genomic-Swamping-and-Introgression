...
gatk SelectVariants \
 ...
 -O /gpfs01/home/pmyla1/160524_data/160524_NO_SPU_allUKtets.vcf.gz
...
cp ./160524_NO_SPU_allUKtets.vcf.gz ./160524_NO_SPU_allUKtets_copy.vcf.gz

gunzip ./160524_NO_SPU_allUKtets_copy.vcf.gz
...
./160524_prune_ld -vcf ./160524_NO_SPU_allUKtets_copy.vcf -mis 0.8 -maf 0.05 -r2 100 50 0.1 > ./160524_ld_pruned_20PCTmis_maf005_NO_SPU_copy.vcf 
...
cp ./160524_ld_pruned_20PCTmis_maf005_NO_SPU_copy.vcf ./160524_ld_pruned_20PCTmis_maf005_NO_SPU.vcf

module load htslib-uoneasy/1.18-GCC-13.2.0
##bgzip the ld_pruned.vcf file
bgzip ./160524_ld_pruned_20PCTmis_maf005_NO_SPU.vcf
