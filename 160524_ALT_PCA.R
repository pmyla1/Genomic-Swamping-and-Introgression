...
vcf <- read.vcfR("150524_ld_pruned_20PCTmis_maf005_EU_UK_pops.vcf.gz") #Filtered and LD-pruned VCF file
...
ggplot(pcs, aes(PC1, PC2, color=as.factor(ploidy)))+
  ...
  geom_text_repel(aes(label=id), size=2.5, force=50, color="black")+
